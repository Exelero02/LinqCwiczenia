...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Emps.Select(e => new { Ename = e.Ename, Job = e.Job, Hiredate = e.HireDate })
        ...
        public static IEnumerable<Dept> Task16()
        {
            IEnumerable<Dept> result = from dept in Depts
                join emp in Emps on dept.Deptno equals emp.Deptno into empDept
                from emp in empDept.DefaultIfEmpty()
                select dept;
            //result =
            return result;
        }
